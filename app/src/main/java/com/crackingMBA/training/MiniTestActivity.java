...
public class MiniTestActivity extends AppCompatActivity {
    TextView minitest_tv, minitest_rules, minitest_analysis;
    Button minitest_attempt_test, minitest_leaderboard_btn;
    String exam_id; String mini_test_name, exam_type, analysis_url;String htmltext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        minitest_analysis=(TextView)findViewById(R.id.minitest_analysis);
        ...
        analysis_url= getIntent().getStringExtra("MINI_TEST_ANALYSIS_URL");
        ...
        minitest_attempt_test.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("The test will be launched in the crackingMBA portal on your phone.")
                        .setCancelable(false)
                        ...
                        .setNeutralButton("CANCEL", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                //Toast.makeText(MiniTestActivity.this, "Cancelled", Toast.LENGTH_SHORT).show();
                                //Intent browserIntent=new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.crackingmba.com/prep"));
                                //startActivity(browserIntent);
                            }
                        });
        ...
        minitest_analysis.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(getApplicationContext(), DailyDoseVideoActivity.class);
                intent.putExtra("DAILY_DOSE_TEST_NAME", mini_test_name);
                intent.putExtra("DAILY_DOSE_VIDEO_URL", analysis_url);
                startActivity(intent);
            }
        });
        ...
        if(exam_type.equals("free")){
            ...
            htmltext="<p>1. This is a <b>FREE</b> test</p>" +
                    ...
                    "<p>6. If you need any help, please drop a mail to <b>support@crackingmba.com</b></p>";
        }

        if(exam_type.equals("paid")){

            htmltext="<p>1. This is a <b>PREMIUM</b> test available to all enrolled users.</p>" +
                    "<p>2. Please enroll for SNAP or XAT Challenge Course for Rs 300 to access all PREMIUM tests</p>" +
